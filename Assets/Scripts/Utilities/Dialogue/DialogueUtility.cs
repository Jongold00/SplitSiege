...
public class DialogueUtility : MonoBehaviour
{
    ...
    public static List<DialogueCommand> ProcessInputString(string toProcess, out string proccessed)
    {
        List<DialogueCommand> result = new List<DialogueCommand>();
        proccessed = toProcess;

        proccessed = HandlePauseTags(proccessed, result);
        proccessed = HandleSpeedTags(proccessed, result);
        proccessed = HandleAnimStartTags(proccessed, result);
        proccessed = HandleAnimEndTags(proccessed, result);
